...
- Root path: `/home/helton/git/build-iso/include/usr/local/bin`
...
- `gum/` — TODO: Describe the purpose of this directory.
- `DEBIAN_ZFS-grub-backup.sh/` — TODO: Describe the purpose of this directory.
- `install-system.sh/` — TODO: Describe the purpose of this directory.
