...
O sistema DEVE detectar automaticamente se o ambiente atual foi iniciado em modo UEFI ou Legacy BIOS.
...
O sistema DEVE informar ao usuário qual modo de boot foi detectado na tela de boas-vindas.
