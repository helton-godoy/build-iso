...
O sistema DEVE instalar o ZFSBootMenu na partição ESP para boot UEFI e configurar suporte para BIOS legado.
...
O sistema DEVE configurar propriedades do ZFS para que o ZFSBootMenu encontre o kernel do Debian.
...
O sistema DEVE gerar e persistir um hostid único para o pool ZFS.
