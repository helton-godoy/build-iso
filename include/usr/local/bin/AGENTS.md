...
## Repository map
- `gum/` — explain what lives here and when agents should edit it.
- `install-aurora-grub-backup.sh/` — explain what lives here and when agents should edit it.
- `install-aurora.sh/` — explain what lives here and when agents should edit it.
