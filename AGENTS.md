...
## Repository map
- `build-debian-trixie-zbm.sh/` — explain what lives here and when agents should edit it.
- `cache/` — explain what lives here and when agents should edit it.
- `clean-build-artifacts.sh/` — explain what lives here and when agents should edit it.
- `code_analysis_report.md/` — explain what lives here and when agents should edit it.
- `current_checksums.txt/` — explain what lives here and when agents should edit it.
- `debian_readme.md/` — explain what lives here and when agents should edit it.
- `docker-entrypoint.sh/` — explain what lives here and when agents should edit it.
- `download-zfsbootmenu.sh/` — explain what lives here and when agents should edit it.
