---
description: Cria um ticket estruturado para bugs, funcionalidades ou dívidas técnicas com base na entrada do usuário. Extrai palavras-chave e padrões para a fase de pesquisa.
---
