---
description: Registra as alterações locais em commits atômicos. Este comando é mais indicado após a conclusão bem-sucedida de uma execução (*execute run*) e na preparação para a revisão do plano (*plan review*).
---
